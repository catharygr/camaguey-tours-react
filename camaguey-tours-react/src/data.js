export default [
  {
    ...
    description:
      "El símbolo de la ciudad de Camagüey es la olla de barro o tinajón , utilizada para captar el agua de lluvia y mantenerla fresca. Camagüey es también cuna de Ignacio Agramonte (1841), figura importante de la Guerra de los Diez Años contra España. Un monumento del escultor italiano Salvatore Buemi, erigido en el centro de la zona a Ignacio Agramonte, fue inaugurado por su esposa en 1912. Está compuesto por una estatua ecuestre, relieves en bronce que revelan fragmentos de la vida de Agramonte, y una escultura de una mujer que simboliza la patria.En julio de 2008, el casco antiguo fue designado Patrimonio de la Humanidad por la UNESCO, debido a su planificación urbana irregular y laberíntica, su papel destacado en la agricultura y la colonización española temprana, y su rica arquitectura que muestra una variedad de influencias.",
    price: "25",
    category: "conocer",
    type: "camaguey",
  ...
  },
  {
    ...
    summary:
      "Las opciones de alojamiento en Camagüey incluyen hoteles, apartamentos privados, hostales. Los hoteles ofrecen una variedad de servicios, como restaurantes, bares y acceso directo al casco histórico. Los apartamentos privados ofrecen más espacio y privacidad que los hoteles. Los albergues son una opción económica para personas que viajan solas o en grupo. Las casas de camapaña ofrecen una experiencia rústica para los visitantes que quieren estar más cerca de la playa.",
    description:
      "Si buscas un destino para tu próxima escapada, lo has encontrado: ¡Camagüey! Tanto si estás de pasada como si piensas quedarte unos días en la ciudad, en los alrededores de Camagüey encontrarás el alojamiento que mejor se adapte a tus necesidades. Echa un vistazo al mapa de Hoteles.com y busca los hoteles de Camagüey que más te interesen. En el mapa verás las zonas y los barrios en los que se sitúa cada hotel de Camagüey, por lo que puedes comprobar a qué distancia estás de los lugares de interés y las atracciones turísticas que prefieras y ampliar la búsqueda si es necesario. Gracias a nuestra garantía de mejor precio, aquí encontrarás fantásticas ofertas de hoteles en Camagüey. Estos alojamientos incluyen aparcamiento gratis: Casa Angel y Jessica, Casa Leo y Oraima y Hostal Doña Luz. Además, puedes echar un ojo a las 46 opciones de nuestro sitio web. Aquí tienes algunos hoteles donde podrás alojarte con tu mascota: Hostal Carmencita, Carmen Gonzalez Fonseca, Casa Pena y Casa Colonial Mirta y Candido. También puedes echar un ojo a las 36 opciones en nuestro sitio web. Algunos alojamientos ideales si viajas con menores son: Casa Maria, Casa Eduardo y Geraldine y Casa Hostal Ivan & Lucy. También puedes ver las 8 opciones que encontrarás en nuestro sitio web. Camagüey, donde la temperatura media en los meses más fríos es de 25 °C, es un destino recomendable en cualquier época del año.",
    price: "25",
    category: "conocer",
    type: "camaguey",
  ...
  },
  {
    ...
    description:
      "En pleno corazón de Cuba se encuentra la pintoresca provincia de Camagüey, un lugar en el que la historia y la naturaleza coexisten de forma armoniosa y casi mágica. Visitándola podrás conocer sus hermosas playas, o recorrer sus calles y maravillarte con la elegante arquitectura de sus edificios y monumentos que recuerdan lo mejor de sus tiempos coloniales.La belleza de Camagüey ha logrado deslumbrar a miles de personas en todo el mundo, pero aún más su increíble centro histórico, el cual fue declarado Patrimonio Cultural de la Humanidad por la UNESCO desde el año 2008. Atrévete a conocer sus calles, plazas y callejones en tu próximo viaje. La ciudad de Camagüey es una introducción a la historia misma de Cuba y del Caribe. El Museo de San Juan de Dios, distintivo por erigirse en lo que era antes un hospital, es perfecto para tener un acercamiento al pasado de la localidad. Camagüey vio nacer a ilustres personajes cubanos, como el independentista Ignacio Agramonte, o el poeta Nicolás Guillén. En el Museo Casa Natal de Ignacio Agramonte, te adentrarás al pasado y conocerás un poco más de la vida de este ilustre personaje. Asimismo, podrás visitar la Casa Natal de Nicolás Guillén, lugar donde los libros del poeta son expuestos al público.",
    price: "40",
    category: "conocer",
    type: "camagüey",
